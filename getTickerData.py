    ...
    for y in range(2018, 2020):
        ...
        for m in range(1, 13):
            ...
            for d in range(1, 32):
                ...
                # format: yyyy-mm-dd can't have single digit for month or day
                url = "https://api.polygon.io/v2/ticks/stocks/nbbo/DG/" \
                      "{}?limit={}&apiKey={redactedAPIKEY}".format(date, limit)
                ...
                ws.append(b)
                ws.append(c)
                saver = "DG-{}-prices.xlsx".format(date)
                wb.save(saver)
